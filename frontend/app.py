...
<div class="main-header">
    <h3 style="margin:0; color:#1d4ed8; font-size:22px; font-weight:700;">🏗️ Amplytico Reference Intelligence Agent</h3>
...
if not st.session_state.messages:
    ...
    <div class="welcome-card">
        ...
        <div class="welcome-title">Amplytico Reference Intelligence Agent</div>
